...
function FormaZadatak({ onKreirano }) {
  ...
  async function onSubmit(e) {
    ...
    const prioritet = forma.prioritet.value
    const dodeljeniId = parseInt(
      forma.dodeljeni.value,
      10,
    )
      ...
      <Card.Body>
        ...
        >
          <Form.Group className="mb-3">
            ...
            <Form.Control
              name="naslov"
              placeholder="Npr. Popis inventara"
              required
            />
          </Form.Group>
